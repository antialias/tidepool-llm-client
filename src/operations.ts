...
> extends AiRequestBase<TUsageContext> {
  schema: TSchema;
  images?: readonly string[] | undefined;
  reasoningEffort?: ReasoningEffort | undefined;
}

export interface AiTextRequest<TUsageContext extends object = object>
  extends AiRequestBase<TUsageContext> {
  images?: readonly string[] | undefined;
  reasoningEffort?: ReasoningEffort | undefined;
}

export interface AiStreamObjectRequest<
  TSchema extends z.ZodType,
  TUsageContext extends object = object,
> extends AiRequestBase<TUsageContext> {
  schema: TSchema;
...
export interface AiEmbedRequest<TUsageContext extends object = object>
  extends AiRequestBase<TUsageContext> {
  input: string | readonly string[];
  dimensions?: number | undefined;
}

export interface AiImageEditRequest<TUsageContext extends object = object>
  extends AiRequestBase<TUsageContext> {
...
export interface AiObjectResult<
  TOutput,
  TUsageContext extends object = object,
> extends AiResultBase<TUsageContext> {
...
export interface AiTextResult<TUsageContext extends object = object>
  extends AiResultBase<TUsageContext> {
  operation: "text";
  output: string;
  usage: TokenUsage;
...
export interface AiStreamObjectResult<
  TOutput,
  TUsageContext extends object = object,
> extends AiResultBase<TUsageContext> {
...
export interface AiEmbedResult<TUsageContext extends object = object>
  extends AiResultBase<TUsageContext> {
  operation: "embedding";
...
export interface AiImageEditResult<TUsageContext extends object = object>
  extends AiResultBase<TUsageContext> {
...
export type AiOperationEnvelope<TUsageContext extends object = object> =
  | AiObjectOperationEnvelope<z.ZodType, TUsageContext>
  | AiTextOperationEnvelope<TUsageContext>
  | AiStreamObjectOperationEnvelope<z.ZodType, TUsageContext>
  | AiEmbedOperationEnvelope<TUsageContext>
  | AiImageEditOperationEnvelope<TUsageContext>;

export interface AiOperationEnvelopeBase<
  TKind extends AiOperationKind,
  TUsageContext extends object = object,
> {
  operation: TKind;
  intent?: string | undefined;
...
export interface AiObjectOperationEnvelope<
  TSchema extends z.ZodType,
  TUsageContext extends object = object,
> extends AiOperationEnvelopeBase<"text-object", TUsageContext> {
...
export interface AiTextOperationEnvelope<TUsageContext extends object = object>
  extends AiOperationEnvelopeBase<"text", TUsageContext> {
...
export interface AiStreamObjectOperationEnvelope<
  TSchema extends z.ZodType,
  TUsageContext extends object = object,
> extends AiOperationEnvelopeBase<"text-stream", TUsageContext> {
  request: AiStreamObjectRequest<TSchema, TUsageContext>;
  jsonSchema: Record<string, unknown>;
  prompt: string;
}

export interface AiEmbedOperationEnvelope<TUsageContext extends object = object>
  extends AiOperationEnvelopeBase<"embedding", TUsageContext> {
  request: AiEmbedRequest<TUsageContext>;
}

export interface AiImageEditOperationEnvelope<TUsageContext extends object = object>
  extends AiOperationEnvelopeBase<"image-edit", TUsageContext> {
  request: AiImageEditRequest<TUsageContext>;
}

export type AiOperationResult<TOperation extends AiOperationEnvelope> =
  TOperation extends AiObjectOperationEnvelope<infer TSchema, infer TUsageContext>
    ? AiObjectResult<z.infer<TSchema>, TUsageContext>
    : TOperation extends AiTextOperationEnvelope<infer TUsageContext>
      ? AiTextResult<TUsageContext>
      : TOperation extends AiStreamObjectOperationEnvelope<
            infer TSchema,
            infer TUsageContext
          >
        ? AiStreamObjectResult<z.infer<TSchema>, TUsageContext>
        : TOperation extends AiEmbedOperationEnvelope<infer TUsageContext>
          ? AiEmbedResult<TUsageContext>
          : TOperation extends AiImageEditOperationEnvelope<infer TUsageContext>
            ? AiImageEditResult<TUsageContext>
            : never;
...
export type AiProviderCallOutcome =
  | AiProviderCallSuccess
  | AiProviderCallValidationFailure;
...
export const DEFAULT_AI_FALLBACK_POLICY: AiFallbackPolicy = {
  mode: "none",
};

export function parseAiModelReference(
  reference: string | AiModelReference,
): ParsedAiModelReference {
